 ...
 */
function kwik_utility_payments(string $apiKey = KWIKAPI_KEY, string $number = 'CONSUMER_NUMBER', string $amount = '500', string $opid = 'OPERATOR_ID', string $order_id = 'YOUR_UNIQUE_ORDER_ID', string $mobile = '9999999999'): array
{
...
// ── Example usage ─────────────────────────────────────────────────────────────
try {
    $result = kwik_utility_payments(KWIKAPI_KEY, 'CONSUMER_NUMBER', '500', 'OPERATOR_ID', 'YOUR_UNIQUE_ORDER_ID', '9999999999');
