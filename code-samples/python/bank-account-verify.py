...
def bank_account_verify(api_key: str = 'YOUR_API_KEY', account: str = 'ACCOUNT_NUMBER', ifsc: str = 'SBIN0001234', order_id: str = 'YOUR_UNIQUE_ORDER_ID') -> dict[str, Any]:
    """
    ...
    with requests.Session() as session:
        ...
        response = session.post(url, data={'api_key': api_key, 'account': account, 'ifsc': ifsc, 'order_id': order_id})
...
if __name__ == "__main__":
    try:
        result = bank_account_verify('YOUR_API_KEY', 'ACCOUNT_NUMBER', 'SBIN0001234', 'YOUR_UNIQUE_ORDER_ID')
        import json
