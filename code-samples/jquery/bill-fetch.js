 ...
 */
function billFetch(api_key = 'YOUR_API_KEY', number = 'CONSUMER_NUMBER', opid = 'OPERATOR_ID', order_id = 'YOUR_ORDER_ID', mobile = '9999999999') {
  const data = { api_key: api_key, number: number, opid: opid, order_id: order_id, mobile: mobile };
...
// ── Example usage ─────────────────────────────────────────────────────────────
$(function () {
  billFetch('YOUR_API_KEY', 'CONSUMER_NUMBER', 'OPERATOR_ID', 'YOUR_ORDER_ID', '9999999999')
